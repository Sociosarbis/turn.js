...
var has3d,
	...
	turnMethods = {
		...
		init: function (options) {
			...
			options = __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].extend({
				width: this.width(),
				height: this.height(),
			...
			data.eventHandlers = {
				touchStart: __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].proxy(turnMethods._touchStart, this),
				touchMove: __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].proxy(turnMethods._touchMove, this),
				touchEnd: __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].proxy(turnMethods._touchEnd, this),
				start: __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].proxy(turnMethods._eventStart, this)
			};
			...
			for (i = 0; i < ch.length; i++) {
				if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(ch[i]).attr('ignore') != '1') {
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).bind(mouseEvents.down, data.eventHandlers.touchStart).
				bind('end', turnMethods._eventEnd).
				bind('pressed', turnMethods._eventPressed).
				bind('released', turnMethods._eventReleased).
				bind('flip', turnMethods._flip);

			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).parent().bind('start', data.eventHandlers.start);

			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(document).bind(mouseEvents.move, data.eventHandlers.touchMove).
		...
		addPage: function (element, page) {
			...
			if ((currentPage = /\bp([0-9]+)\b/.exec(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(element).attr('class'))))
			...
			if (page >= 1 && page <= lastPage) {
				...
				// Add element
				data.pageObjs[page] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(element).
					css({ 'float': 'left' }).
		...
		center: function (page) {
			...
			var data = this.data(),
				size = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).turn('size'),
				left = 0;
			...
			if (!data.noCenter) {
				...
				__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).css({ marginLeft: left });
			}
		...
		destroy: function () {
			...
			__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].each(events, function (index, eventName) {
				flipbook.unbind(eventName);
			});

			this.parent().unbind('start', data.eventHandlers.start);

			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(document).unbind(mouseEvents.move, data.eventHandlers.touchMove).
		...
		zoom: function (newZoom) {
			...
			if (typeof (newZoom) == 'number') {
				...
				__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).turn('stop').
				...
				switch (display) {
					case 'single':
						...
						if (!data.pageObjs[0]) {
							...
							data.pageObjs[0] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div />',
		...
		direction: function (dir) {
			...
			if (dir === undefined) {
				...
				if (__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(dir, directions) == -1)
					throw turnError('"' + dir + '" is not a value for direction');

				if (dir == 'rtl') {
					__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).attr('dir', 'ltr').
						css({ direction: 'ltr' });
				}
				...
				if (data.done)
					this.turn('size', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).width(), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this).height());
			...
			for (page in data.pages) {
				if (has(page, data.pages))
					data.pages[page].flip('disable',
						(data.disabled) ? true : __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(parseInt(page, 10), view) == -1);
			}
		...
		_turnPage: function (page) {
			...
			if (data.page != page) {
				...
				if (trigger('turning', this, [page, newView]) == 'prevented') {
					...
					if (currentPage == data.page && __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(place, data.pageMv) != -1)
				...
				if (__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(1, newView) != -1)
					this.trigger('first');
				if (__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(data.totalPages, newView) != -1)
					this.trigger('last');
		...
		_eventEnd: function (e, opts, turned) {
			...
			var that = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(e.target),
				data = that.data().f,
				turn = opts.turn,
				dd = turn.data();
		...
		_eventPressed: function (e) {
			...
			var page,
				data = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(e.target).data().f,
				turn = data.opts.turn,
				turnData = turn.data(),
		...
		_eventReleased: function (e, point) {
			...
			var outArea,
				page = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(e.target),
				data = page.data().f,
				turn = data.opts.turn,
				turnData = turn.data();
		...
		_flip: function (e) {
			...
			var opts = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(e.target).data().f.opts;
				...
				for (page in data.pageWrap) {
					...
					if ((p = data.pages[page])) {
						...
						if (data.tpage) { // Is it turning the page to `tpage`?
							...
							p.flip('hover', false).
								flip('disable',
									__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(parseInt(page, 10), data.pageMv) == -1 &&
									page != newView[0] &&
									page != newView[1]);
		...
		_updateShadow: function () {
			...
			if (!data.shadow) {
				data.shadow = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div />', {
					'class': 'shadow',
		...
		options: function (options) {
			...
			if (options === undefined) {
				...
				__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].extend(data.opts, options);
	...
	flipMethods = {
		...
		options: function (opts) {
			...
			if (opts) {
				flipMethods.setData.call(this,
					{ opts: __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].extend({}, data.opts || flipOptions, opts) });
				return this;
			} else
				return data.opts;
		...
		_cornerActivated: function (p) {
			...
			return (!point.corner || __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(point.corner, allowedCorners) == -1) ?
				false : point;
			...
			if (!data.wrapper)
				switch (data.effect) {
					case 'hard':
						...
						data.wrapper = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div/>', divAtt(0, 0, 2)).
							css(cssProperties).
							appendTo(parent).
							prepend(this);

						data.fpage = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div/>', divAtt(0, 0, 1)).
							css(cssProperties).
							appendTo(parent);

						if (turnData.opts.gradients) {
							data.ashadow = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div/>', divAtt(0, 0, 0)).
								hide().
								appendTo(parent);

							data.bshadow = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div/>', divAtt(0, 0, 0));
						}
					...
					case 'sheet':
						...
						data.fpage = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])('<div/>', divAtt(0, 0, 0, 'visible')).
							css({ cursor: 'default' }).
		...
		peel: function (corner, animate) {
			...
			if (corner) {
				...
				if (__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(corner, corners.all) == -1)
					throw turnError('Corner ' + corner + ' is not permitted');

				if (__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].inArray(corner, flipMethods._cAllowed.call(this)) != -1) {
...
function trigger(eventName, context, args) {
	...
	var event = __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].Event(eventName);
...
__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].extend(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].fn, {
	...
	flip: function () {
		return dec(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this[0]), flipMethods, arguments);
	},

	turn: function () {
		return dec(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */])(this[0]), turnMethods, arguments);
	},
	...
	animatef: function (point) {
		...
		if (point) {
			...
			data.effect = __WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].extend({
				stop: function () {
					animating = false;
				},
...
__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].mouseEvents = mouseEvents;
__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].cssPrefix = getPrefix;
__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].cssTransitionEnd = getTransitionEnd;
__WEBPACK_IMPORTED_MODULE_0__jqueryAlternate__["a" /* default */].findPos = findPos;
